package com.xyan.core.exception;
    ...
    protected ModelAndView doResolveHandlerMethodException(HttpServletRequest request, HttpServletResponse response, HandlerMethod handlerMethod, Exception exception) {
        ...
        if (responseBodyAnn != null) {
            try {
                ...
                if (returnValue == null) {
                    ...
                    respn.setReturnCode("500");
                    respn.setMessage(exception.getLocalizedMessage());
                    respn.setTimestamp(DateUtil.getTimestamp(null));
        ...
        if( null == returnValue) {
            ...
            if (null == returnValue.getViewName()) {
                returnValue.addObject("errorMessage", exception.getLocalizedMessage()).setViewName(defaultErrorView);
            }
        }
        return returnValue;
    }
