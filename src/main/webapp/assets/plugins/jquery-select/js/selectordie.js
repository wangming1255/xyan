...
; (function ($) {
    $.fn.selectOrDie = function (method) {
        ...
        var $defaults = {
            ...
            $_settings = {},
            $_sodFilterTimeout, $_sodViewportTimeout,$native;
        var _private = {
                ...
                return this.each(function (i) {
                    ...
                    if ( !$(this).parent().hasClass("sod_select") ) {
                        var $select                = $(this),
                            ...
                            $native.after("<input type=\"hidden\" id=\""+$native.prop("id")+"Name\" name=\""+$native.prop("id")+"Name\">");
                            $native.after("<input type=\"hidden\" id=\""+$native.prop("id")+"Id\" name=\""+$native.prop("id")+"Id\">");
            ...
            optionClick: function (e) {
                e.stopPropagation();
                $("#"+$native.prop("id")+"Id").val($(this).data("value"));
                $("#"+$native.prop("id")+"Name").val($(this).text());
                var $clicked        = $(this),
